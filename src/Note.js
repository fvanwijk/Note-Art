...
import { firstToUpper, notes, circle_of_fourths, semitone } from ".";
...
export class Note {
  ...
  constructor(attributes = {}) {
    ...
    this._note =
      !notes["#"].includes(note) && !notes.b.includes(note) ? "A" : note;
    this._octave =
  ...
  getInterval(interval) {
    ...
    return new Note({
      note:
        notes[this.lang][Math.abs((this.index + (12 + (interval % 12))) % 12)],
