import { NotesHash, firstToUpper, notes, circle_of_fourths, semitone } from "."
import { Howl } from "howler"

const sounds = new Map()
// const noteshash = NotesHash.getNotesHash()
/**
 * @class
...
export class Note {
    ...
    constructor(attributes = {}) {
        ...
        const defaults = { note: 'C', octave: 3, duration: 'q', instrument: 'Piano', ...attributes }
        this.attributes = []
        ...
        NotesHash.getNotesHash().set(this)
    }
     ...
     */
    play() {
        NotesHash.getNotesHash().get(this).play()
    }
}